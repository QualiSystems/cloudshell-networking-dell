...
class DNOSSnmpIfPort(SnmpIfPort):
    ...
    def __init__(
        ...
        super(DNOSSnmpIfPort, self).__init__(
    ...
    def _get_adjacent(self):
        ...
        for key, value in self._port_attributes_snmp_tables.cdp_table.items():
            if str(key).startswith(str(self.if_index)):
                ...
                break
        if result == "":
            result = super(DNOSSnmpIfPort, self)._get_adjacent()
        return result
    ...
    def _get_auto_neg(self):
        ...
        if cisco_duplex:
            ...
            return super(DNOSSnmpIfPort, self)._get_auto_neg()
    ...
    def _get_duplex(self):
        ...
        if cisco_duplex:
            ...
            return super(DNOSSnmpIfPort, self)._get_duplex()
